...
class EmployeeTable:
    ...
    def create_employee(self, first_name: str, last_name: str, phone: str, id: int) -> None:
    ...
    def update_employee(self, new_first_name: str, new_last_name: str, id: int, new_phone: str = None) -> None:
